...
\section*{Jo Shaw Ai}
\textbf{Email:} ai@kudoswall.com \\
\textbf{Phone:} 987-654-3210 \\
...
\section*{Skills}
01/2022, 06/2022, 3210, 654, 92, 987, a, accuracy, achieved, after, ai, aiming, al, an, analysis, analytical, and, andrew, annual, at, certifications, churn, city, classification, collaborated, contribute, coursera, create, critical, customer, data, dataset, deep, develop, driven, example, expertise, fest, for, github, image, in, innovative, intern, internships, it, iterations, keras, kudoswall.com, labs, languages, learn, learning, leverage, libraries, linkedin, machine, matplotlib, ml, model, models, multiple, ng, on, pandas, passion, pipelines, predict, presented, problem, professional, programming, project, projects, python, r, reasoning, s, scikit, seaborn, skills, soft, solving, specialization, sql, stanford, summary, tableau, team, tensorflow, test, the, thinking, to, toch, university, used, visualization, with, xyz
